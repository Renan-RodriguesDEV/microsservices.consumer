...
- LinkedIn: [linkedin.com/in/renanrodrigues7110](https://linkedin.com/in/renanrodrigues7110)
...
A aplicação foi configurada para ser executada em contêineres Docker. O arquivo `docker-compose.yml` gerencia os serviços necessários, incluindo o banco de dados PostgreSQL e o RabbitMQ.
...
- **consumer**: Serviço principal da aplicação.
- **postgres**: Banco de dados PostgreSQL.
- **rabbitmq**: Fila de mensagens RabbitMQ.

### Variáveis de Ambiente

Certifique-se de configurar as variáveis de ambiente no arquivo `.env` antes de executar os contêineres. Um exemplo de configuração pode ser encontrado em `.env.example`.
...
### Co-Criação (Documentos e afins)

**GitHub Copilot**

- Não sei se ele tem redes sociais :(, mas deve ter tinder
